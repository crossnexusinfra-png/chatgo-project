...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | The following array lists the paths and commands that will not be
    | watched by Telescope. In addition to this list, some commands
    | like migrations and queue workers are ignored by default.
    |
    */
    ...
    | Telescope. The watchers gather the application's data when a request
    | or command is executed. Feel free to customize this list.
    |
    */
