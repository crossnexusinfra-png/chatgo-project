            ...
            <div class="profile-info">
                ...
                <div class="profile-details">
                    ...
                    <div class="detail-item">
                        ...
                        <span class="country-display">
                            <button type="button" class="btn-history" data-action="open-residence-history-modal" data-user-id="{{ $user->user_id }}" title="{{ \App\Services\LanguageService::trans('residence_history_title', $lang) }}">
                                📝
                            </button>
                            @if($residenceCode)
                    ...
                    <div class="detail-item">
                        ...
                        <span class="country-display">
                            <button type="button" class="btn-history" data-action="open-coin-reward-modal" title="{{ \App\Services\LanguageService::trans('view_coin_reward_table', $lang) }}">
                                📊
                            </button>
                ...
                <div class="profile-actions">
                    ...
                    @endif
                    <form action="{{ route('logout') }}" method="POST" class="logout-form" data-confirm-message="{{ \App\Services\LanguageService::trans('logout_confirm', $lang) }}">
                        @csrf
...
<div id="coinRewardModal" class="modal">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <span class="close" data-action="close-coin-reward-modal" role="button" tabindex="0">&times;</span>
        </div>
        <div class="modal-body">
